...
const SiteDance = () => {
  ...
  const uniqueCities = Array.from(new Set(danceData.map(item => item.place.city)));
      ...
      <table>
        ...
        <tbody>
          {filteredDanceData.map((item) => (
            <tr key={item.id}>
              <td>
                <Link to={`/dance/${item.id}`}>{item.name}</Link>
              </td>
              <td>
                <Link to={`/dance/${item.id}`}>{item.place.city}</Link>
              </td>
              <td>
                <Link to={`/dance/${item.id}`}>{item.place.location}</Link>
              </td>
              <td>
